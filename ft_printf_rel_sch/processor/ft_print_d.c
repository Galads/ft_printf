...
static  void    ft_loop(s_cn *list, char **str)
{
...
static  void    flag_minus(s_cn *list, char **str)
{
...
static  void    flag_plus(s_cn *list, char **str, int *accuracy, int *flag)
{
...
static  void    flag_minus_loop(s_cn *list, char **str, int *accuracy)
{
    while (list->width - list->accuracy > 0  && list->width > (int)ft_strlen(*str))
    {
        list->bytes++;
